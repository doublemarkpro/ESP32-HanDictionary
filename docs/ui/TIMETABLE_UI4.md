...
- 真实可点击表格：五个工作日，另有周末视图；按实际课表自动排成五至八节同屏，长课程名点击查看。
- 语文、数学、英语、科学、美术、体育、信息、音乐、武术、劳动、竖笛和选修有不同颜色和图标；民乐团复用音乐图标。
...
十二个课程 40×40 PNG 来自既有原创矢量图标系统；背景和吉祥物复用已有资源。
...
模拟器验证空白 / 非法 / 演示数据、七节同屏、周末、本周下周、物品勾选和分页、离线语音保护，
