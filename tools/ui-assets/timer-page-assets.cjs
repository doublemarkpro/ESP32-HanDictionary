...
async function build() {
  ...
  const specs = [
    ['han_font_timer', 28,
      '语文数学英语今日作业已完成进行中未开始有记录本周用时今天共分钟暂停开始继续完成本科准备正在专注周一二三四五六日不足网络与存储显示声音连接读取状态手机配网模式可使用本地功能卡内容字典音插画资源屏幕亮度播放自动锁立即关长按唤醒再向上滑动解正在切换器Ⅱ▶✓—…'],
    ['han_font_timer_title', 38,
      '今日作业本周用时开始计时暂停周一二三四五网络与存储显示声音'],
  ];
