...
#define MAIN_EVENT_STOP_CONVERSATION (1 << 14)
...
public:
    ...
    /**
     * End the complete voice conversation (event-based, thread-safe).
     * Unlike
     * ToggleChatState(), this never changes a speaking turn back to listening.
     */
    void StopConversation();
    bool IsConversationActive() const { return conversation_active_.load(); }
...
private:
    ...
    void HandleStopConversationEvent();
    ...
    bool IsConversationCurrent(uint32_t generation) const;
